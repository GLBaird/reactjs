    ...
    getNoteLayout: function() {
        return (
            React.createElement("div", {className: "note"}, 
                React.createElement("p", null, this.props.noteText), 
                React.createElement("p", {className: "buttons"}, 
                    React.createElement("button", {onClick: this.editNote, className: "btn btn-sm glyphicon glyphicon-pencil"}, " "), 
                    React.createElement("button", {onClick: this.trashNote, className: "btn btn-sm glyphicon glyphicon-trash"}, " ")
                )
            )
        );
    },
